...
<body>
    ...
    <form action="cadastro_cliente.php" method="POST">
        ...
        <input type="text" id="nome_cliete" name="nome_cliente" required><br>

        <label for="cpf">CPF do cliente:</label><br>
        <input type="text" id="cpf" name="cpf" rows="4" required></input><br>
        ...
        <button type="submit">Cadastrar Cliente</button> <br><br>
    <button><a href="index.php">Deseja Cadastrar Produto? <br> Clique Aqui!</a></button>
    </form>
